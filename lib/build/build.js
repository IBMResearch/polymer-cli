...
exports.mainBuildDirectoryName = path.join('build', 'polymer-cli');
/**
...
function build(options, polymerProject) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const buildDirectory = path.join(exports.mainBuildDirectoryName);
        ...
        function getPolymerVersion() {
            return __awaiter(this, void 0, void 0, function* () {
                return new Promise((resolve, _reject) => bower.commands.list()
                    .on('end', (result) => {
